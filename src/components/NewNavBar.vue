<template>
	<div id="navBar" class="flexCenter">
        <div id="navContent" class="flexCenter">
            ...
            <li><router-link to="/house" class="navList bmjua" style="font-size: 20px">매물찾기</router-link></li>
            <li><router-link to="/chart" class="navList bmjua" style="font-size: 20px">차트 보기</router-link></li>
            <li><router-link to="/community" class="navList bmjua" style="font-size: 20px">커뮤니티</router-link></li>
             
        </div>
        <div id="navLogin" class="flexCenter">
            <li v-if="!this.$store.state.logined"><router-link to="/login" class="navList">Sign in</router-link></li>
            <li v-if="!this.$store.state.logined"><router-link to="/register" class="navList signup">Sign up</router-link></li>
